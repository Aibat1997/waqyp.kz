 ...
 */
class Project extends Section implements Initializable
{
	public function initialize()
	{
		// Добавление пункта меню и счетчика кол-ва записей в разделе
		$this->addToNavigation($priority = 3, function () {
			return \App\Project::count();
		});
	}
	...
	public function onDisplay()
	{
		...
		$display->setColumns(
			...
			AdminColumnEditable::checkbox('is_main', 'Да', 'Нет')->setLabel('На главном')->setWidth('200px'),
	...
	public function onEdit($id)
	{
		...
		$form = AdminForm::panel()
			->addHeader([
				...
				AdminFormElement::checkbox('is_main', 'На главный')->setDefaultValue(0),
