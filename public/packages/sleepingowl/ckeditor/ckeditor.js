...
(function () {
  ...
  CKEDITOR.dom = {};
  (function () {
    var a = [], d = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", b = /&/g, c = />/g, e = /</g, g = /"/g, h = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g, k = {
      lt: "\x3c",
      gt: "\x3e",
      amp: "\x26",
      quot: '"',
  ...
  CKEDITOR.dtd = function () {
    var a = CKEDITOR.tools.extend, d = function (a, b) {
      ...
      table: 1,
      ul: 1
    }, g = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, h = {}, k = {"#": 1}, n = {
      center: 1,
      dir: 1,
      noframes: 1
    };
    ...
    function a(a, b) {
      ...
      if (!a && !this._.guardLTR) {
        ...
        this._.guardLTR = function (a, b) {
          return (!b || !J.equals(a)) && (!h || !a.equals(h)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
        }
      }
  ...
  (function () {
    ...
    function c(a, b, c) {
      if (!a.match || a.match(b)) {
        ...
        b = b.classes;
        if (a) {
          for (var d = !1, l = !0 === a, f = b.length; f--;)if (l || a(b[f])) b.splice(f, 1), d = !0;
          a = d
        } else a = !1;
    ...
    function f(a) {
      var b, c, d, e, l = {}, f = 1;
      for (a = B(a); b = a.match(p);)(c = b[2]) ? (d = C(c, "styles"), e = C(c, "attrs"), c = C(c, "classes")) : d = e = c = null, l["$" + f++] = {
        elements: b[1],
        classes: c,
        styles: d,
        attributes: e
    ...
    function l(a, b, c) {
      ...
      if (z.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(y()) : (a.parent && c.push({
        ...
        b:{
          e = z[b];
          for (var l = 0, f = d.length, t; l < f; ++l)if (t = d[l], t.type == CKEDITOR.NODE_ELEMENT && !e[t.name]) {
            e = !1;
            break b
          }
          e = !0
        ...
        if (e) a.name = b, a.attributes =
          ...
          e = a.parent;
          for (var l = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == e.name, v, r, f = d.length; 0 < f;)t = d[--f], l && (t.type == CKEDITOR.NODE_TEXT || t.type == CKEDITOR.NODE_ELEMENT && z.$inline[t.name]) ? (v || (v = new CKEDITOR.htmlParser.element(b), v.insertAfter(a), c.push({
              check: "parent-down",
              el: v
            })), v.add(t, 0)) : (v = null, r = z[e.name] || z.span, t.insertAfter(a), e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || t.type != CKEDITOR.NODE_ELEMENT || r[t.name] || c.push({
              check: "el-up",
              el: t
            }));
          a.remove()
    ...
    CKEDITOR.filter.prototype = {
      allow: function (b, c, d) {
        ...
        var e = this, f = [], t = this.editor && this.editor.config.protectedSource, v, r = !1, g = {
          doFilter: !c,
          doTransform: !0,
          doCallbacks: !0,
          toHtml: b
        ...
        if (!this.disabled && a) {
          ...
          for (e = 0; e < a.length; ++e) {
            ...
            for (f = 0; f < b.length; ++f)t = b[f], "string" == typeof t ? (t = t.split(/\s*:\s*/), v = t[0], g = null, p = t[1]) : (v = t.check, g = t.left, p = t.right), l || (l = t, l = l.element ? l.element : v ? v.match(/^([a-z0-9]+)/i)[0] :
                l.left.getDefinition().element), g instanceof CKEDITOR.style && (g = D(g)), c.push({
              check: v == l ? null : v,
              left: g,
    ...
    var V = {styles: 1, attributes: 1, classes: 1}, O = {
        styles: "requiredStyles",
        attributes: "requiredAttributes",
        classes: "requiredClasses"
      }, p = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, F = {
        styles: /{([^}]+)}/,
        attrs: /\[([^\]]+)\]/,
        classes: /\(([^\)]+)\)/
    ...
    N = CKEDITOR.filter.transformationsTools = {
      sizeToStyle: function (a) {
        ...
        if ("string" == typeof b) a.name = b; else {
          ...
          a.name = c.element;
          for (l in e)if ("class" ==
            l)for (c = a.classes.join("|"), f = e[l].split(/\s+/); v = f.pop();)-1 == c.indexOf(v) && a.classes.push(v); else a.attributes[l] = e[l];
  ...
  (function () {
      ...
      CKEDITOR.plugins.load(c.split(","), function (c) {
        ...
        CKEDITOR.scriptLoader.load(f, function () {
          for (var c = ["beforeInit", "init", "afterInit"], l = 0; l < c.length; l++)for (var f =
            0; f < d.length; f++) {
            var v = d[f];
            0 === l && e[f] && v.lang && v.langEntries && (a.lang[v.name] = v.langEntries[e[f]]);
            if (v[c[l]]) v[c[l]](a)
          }
    ...
    function A(a, b) {
      ...
      for (var e = new CKEDITOR.dom.documentFragment, f, g, h, k = 0; k < a.length; k++) {
        ...
        c(r) ? (f ||
          (f = z.getAscendant("table").clone(), f.append(z.getAscendant({
            thead: 1,
            tbody: 1,
            tfoot: 1
          }).clone()), e.append(f), f = f.findOne("thead, tbody, tfoot")), g && g.equals(z) || (g = z, h = z.clone(), f.append(h)), h.append(d(r))) : e.append(r.cloneContents())
      }
    ...
    CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
      addCommand: function (a, b) {
        ...
        if (a = "string" === typeof a ? this.getCommand(a) : a) {
          var b = a && a.name,
            c = this.keystrokeHandler.keystrokes, d;
        ...
        E.onTagOpen = function (e, f, g, h) {
          ...
          if (a(f)) m.push(f); else {
            ...
            if ("br" == e) K.push(f); else {
              for (; !(h = (g = y.name) ? CKEDITOR.dtd[g] || (y._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || y.isUnknown || h[e]);)if (y.isOptionalClose) E.onTagClose(g); else if (e in b && g in b) g = y.children, (g = g[g.length - 1]) && "li" == g.name || C(g = new CKEDITOR.htmlParser.element("li"), y), !f.returnPoint && (f.returnPoint = y), y = g; else if (e in CKEDITOR.dtd.$listItem && !A(e, g)) E.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (g in d && !A(e, g)) !f.returnPoint && (f.returnPoint = y), y = y.parent; else if (g in CKEDITOR.dtd.$inline && m.unshift(y), y.parent) C(y, y.parent, 1); else {
                f.isOrphan = 1;
                break
              }
              n(e);
  ...
  (function () {
    ...
    function b(a) {
      var b = a.name, d = a.element, h = a.elementMode, k =
          ...
          space: "bottom",
          html: ""
        }).html, q = new CKEDITOR.template('\x3c{outerEl} id\x3d"cke_{name}" class\x3d"{id} cke cke_reset cke_chrome cke_editor_{name} cke_{langDir} ' + CKEDITOR.env.cssClass + '"  dir\x3d"{langDir}" lang\x3d"{langCode}" role\x3d"application"' + (a.title ? ' aria-labelledby\x3d"cke_{name}_arialbl"' : "") + "\x3e" + (a.title ? '\x3cspan id\x3d"cke_{name}_arialbl" class\x3d"cke_voice_label"\x3e{voiceLabel}\x3c/span\x3e' : "") + '\x3c{outerEl} class\x3d"cke_inner cke_reset" role\x3d"presentation"\x3e{topHtml}\x3c{outerEl} id\x3d"{contentId}" class\x3d"cke_contents cke_reset" role\x3d"presentation"\x3e\x3c/{outerEl}\x3e{bottomHtml}\x3c/{outerEl}\x3e\x3c/{outerEl}\x3e'),
          ...
          if (!this.is("textarea")) {
            ...
            this.attachListener(a, "key", function (b) {
              ...
              if (c in z) {
                b = a.getSelection();
                var e,
                  r = b.getRanges()[0], p = r.startPath(), h, t, k, c = 8 == c;
      ...
      if (b) {
        ...
        if (!(d = !c) && (d = !c.isHidden())) {
          ...
          var e = c.getRanges(), f = d.getRanges(), g = e.length && e[0]._getTableElement() && e[0]._getTableElement().getAscendant("table",
              !0), h = f.length && f[0]._getTableElement() && f[0]._getTableElement().getAscendant("table", !0), p = 1 === e.length && e[0]._getTableElement() && e[0]._getTableElement().is("table"), k = 1 === f.length && f[0]._getTableElement() && f[0]._getTableElement().is("table"), t = 1 === e.length && e[0].collapsed, f = a(e, !!CKEDITOR.env.webkit) && a(f);
        ...
        var a = x ? function () {
            ...
            var b = function (b, c) {
              ...
              for (var e = d.children, f, g, h = b.duplicate(), k = 0,
                     l = e.length - 1, r = -1, q, m; k <= l;)if (r = Math.floor((k + l) / 2), f = e[r], h.moveToElementText(f), q = h.compareEndPoints("StartToStart", b), 0 < q) l = r - 1; else if (0 > q) k = r + 1; else return {
                container: d,
                offset: a(f)
              };
              ...
              for (; 0 < h;)try {
                g = f[0 < q ? "previousSibling" : "nextSibling"], g.nodeType == CKEDITOR.NODE_TEXT && (h -= g.nodeValue.length, m = g), f = g
              } catch (n) {
                return {container: d, offset: a(f)}
              }
              return {container: m, offset: 0 < q ? -h : m.nodeValue.length + h}
            };
            return function () {
    ...
    CKEDITOR.plugins.add("pastefromword", {
      requires: "clipboard", init: function (a) {
        ...
        a.on("paste", function (d) {
          var b = d.data, g = (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported ? b.dataTransfer.getData("text/html", !0) : null) || b.dataValue, e = {dataValue: g}, h = /(class=\"?Mso|style=(?:\"|\')[^\"]*?\bmso\-|w:WordDocument|<o:\w+>|<\/font>)/, h = /<meta\s*name=(?:\"|\')?generator(?:\"|\')?\s*content=(?:\"|\')?microsoft/gi.test(g) || h.test(g);
      ...
      if (d) {
        for (var f = d.getRanges(), a = [], g = {}, h = 0; h < f.length; h++) {
          ...
          if (k.collapsed) (k = k.getCommonAncestor().getAscendant({td: 1, th: 1}, !0)) && b(k) && a.push(k); else {
            ...
            CKEDITOR.NODE_ELEMENT && l.is(CKEDITOR.dtd.table) || (l = l.getAscendant({
              td: 1,
              th: 1
            }, !0)) && !l.getCustomData("selected_cell") && b(l) && (CKEDITOR.dom.element.setMarker(g, l, "selected_cell", !0), a.push(l))
          }
        }
  ...
  (function () {
    function B(a, b) {
      var c = a.getAscendant("table"), d = b.getAscendant("table"), k = CKEDITOR.tools.buildTableMap(c), f = a.getAscendant("tr", !0).$.rowIndex, e = b.getAscendant("tr", !0).$.rowIndex, p = [], r = {}, n, l;
      c.contains(d) && (b = b.getAscendant({td: 1, th: 1}), e = b.getAscendant("tr", !0).$.rowIndex);
      f > e && (c = f, f = e, e = c, c = a, a = b, b = c);
      for (c = 0; c < k[f].length; c++)if (a.$ === k[f][c]) {
        n = c;
        break
      }
      for (c = 0; c < k[e].length; c++)if (b.$ === k[e][c]) {
        l = c;
        break
      }
      n > l && (c = n, n = l, l = c);
      for (c = f; c <= e; c++)for (f = n; f <= l; f++)d = new CKEDITOR.dom.element(k[c][f]),
      d.$ && !d.getCustomData("selected_cell") && (p.push(d), CKEDITOR.dom.element.setMarker(r, d, "selected_cell", !0));
    ...
    function x(a, b) {
      var c = [], d, k;
      for (k = 0; k < b.length; k++)d = a.createRange(), d.setStartBefore(b[k]), d.setEndAfter(b[k]), c.push(d);
    ...
    function L(a, b, c) {
      ...
      b = b.is("table") ? null : b;
      var k;
      (k = h.active && !h.first) && !(k = b) && (k = a.getSelection().getRanges(), k = 1 < d.length || k[0] && !k[0].collapsed ? !0 : !1);
      if (k) h.first = b || d[0], h.dirty = b ? !1 : 1 !== d.length; else if (h.active && b) {
        d = B(h.first, b);
    ...
    function y(a) {
      ...
      function c(a) {
        return !a.getAscendant("table", !0) && a.getDocument().equals(d.document)
      }

      var d = a.editor || a.listenerData.editor, k = d.getSelection(1), f = J(d), e = a.data.getTarget(), p = e && e.getAscendant({
          td: 1,
          th: 1
        }, !0), e = e && e.getAscendant("table", !0), r = {table: 1, thead: 1, tbody: 1, tfoot: 1, tr: 1, td: 1, th: 1};
      (function (a, d, f, e) {
        return "mousedown" === a.name && (D(a) || !e) || "mouseup" === a.name && !c(a.data.getTarget()) && !b(f, e) ? !0 : !1
      })(a, k, f, e) && C(d, !0);
      !h.active && "mousedown" === a.name && D(a) && e && (h = {active: !0}, CKEDITOR.document.on("mouseup",
        y, null, {editor: d}));
      (p || e) && L(d, p || e, a);
      "mouseup" === a.name && (D(a) && (c(a.data.getTarget()) || b(f, e)) && K(d), h = {active: !1}, CKEDITOR.document.removeListener("mouseup", y))
    }
    ...
    function O(a, b) {
      ...
      var d = a.getSelection(), k = d.createBookmarks(), f = a.document, e = a.createRange(), p = f.getDocumentElement().$, r = CKEDITOR.env.ie && 9 > CKEDITOR.env.version,
        n = a.blockless || CKEDITOR.env.ie ? "span" : "div", l, m, z, q;
      f.getById("cke_table_copybin") || (l = f.createElement(n), m = f.createElement(n), m.setAttributes({
        ...
        height: "1px",
        overflow: "hidden"
      }), l.setStyle("ltr" == a.config.contentsLangDirection ? "left" : "right", "-5000px"), l.setHtml(a.getSelectedHtml(!0)), a.fire("lockSnapshot"), m.append(l), a.editable().append(m), q = a.on("selectionChange", c, null, null, 0), r && (z = p.scrollTop), e.selectNodeContents(l),
        e.select(), r && (p.scrollTop = z), setTimeout(function () {
        m.remove();
        d.selectBookmarks(k);
        q.removeListener();
        a.fire("unlockSnapshot");
    ...
    function P(a) {
      ...
      var k = a.editor, f = k.dataProcessor, e = k.getSelection(), p = new CKEDITOR.dom.element("body"), r = 0, n = 0, l = 0, m = 0, z = {}, q, g, h, u, w, v;
      ...
      if (e.getRanges().length && (e.isInTable() || (q = b(e))) && (g = t(e), g.length)) {
        ...
        if (1 < p.getChildCount() || !m) g[0].setHtml(p.getHtml()), k.fire("saveSnapshot"); else {
          if (q) {
            g = l.getChildCount();
            l = w = new CKEDITOR.dom.element("tr");
            l["insert" + (1 === q ? "Before" : "After")](h.getParent());
            for (f = 0; f < g; f++)h = new CKEDITOR.dom.element("td"), h.appendTo(l);
            h = l.getFirst();
            u = l.getLast();
            e.selectElement(l);
            g = t(e)
          ...
          l = c(e);
          m = c(q);
          if (e.length > q.length)for (r = e.length - q.length, f = 0; f < r; f++)H(g);
          ...
          for (f = 0; f < e.length; f++)for (n = new CKEDITOR.dom.element(a.$.rows[l.$.rowIndex +
          f]), g = 0; g < e[f].length; g++)if (v = new CKEDITOR.dom.element(e[f][g]), p = q[f] && q[f][g] ? new CKEDITOR.dom.element(q[f][g]) : null, v && !v.getCustomData("processed")) {
            if (p && p.getParent()) v.replace(p); else if (0 === g || e[f][g - 1]) (p = 0 !== g ? new CKEDITOR.dom.element(e[f][g - 1]) : null) && n.equals(p.getParent()) ? v.insertAfter(p) : 0 < r ? v.insertAfter(new CKEDITOR.dom.element(n.$.cells[r])) : n.append(v, !0);
      ...
      getCellsBetween: B, keyboardIntegration: function (a) {
        ...
        c.attachListener(c, "keydown", function (a) {
            function c(b, f) {
              ...
              var k = a.createRange(), l = CKEDITOR.dom.range.mergeRanges(f);
              CKEDITOR.tools.array.forEach(l, function (a) {
                a.enlarge(CKEDITOR.ENLARGE_ELEMENT)
              });
              var m = l[0].getBoundaryNodes(), h = m.startNode, m = m.endNode;
              if (h && h.is && h.is(e)) {
                for (var q = h.getAscendant("table", !0), g = h.getPreviousSourceNode(!1,
                  CKEDITOR.NODE_ELEMENT, q), t = !1, u = function (a) {
                  return !h.contains(a) && a.is && a.is("td", "th")
                }; g && !u(g);)g = g.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, q);
                !g && m && m.is && !m.is("table") && m.getNext() && (g = m.getNext().findOne("td, th"), t = !0);
                if (g) k["moveToElementEdit" + (t ? "Start" : "End")](g); else k.setStartBefore(h.getAscendant("table", !0)), k.collapse(!0);
                l[0].deleteContents();
                return [k]
              }
            ...
            delete e.th;
            return function (e) {
              var h = e.data.getKey(), n, l = 37 === h || 38 == h, m, t, q;
              if (f[h] && (n = a.getSelection()) && n.isInTable() && n.isFake)if (m = n.getRanges(), t = m[0]._getTableElement(), q = m[m.length - 1]._getTableElement(), e.data.preventDefault(), e.cancel(), 8 < h && 46 > h) m[0].moveToElementEditablePosition(l ? t : q, !l), n.selectRanges([m[0]]); else {
                for (e = 0; e < m.length; e++)b(m[e]);
                (e = c(t, m)) ? m = e : m[0].moveToElementEditablePosition(t);
                n.selectRanges(m);
                a.fire("saveSnapshot")
              }
            }
        ...
        c.attachListener(c, "keypress", function (d) {
          var c = a.getSelection(), f, e;
          if (c && c.isInTable() && c.isFake && d.data.$.charCode && !(d.data.getKeystroke() & CKEDITOR.CTRL)) {
            d = c.getRanges();
    ...
    CKEDITOR.plugins.add("tableselection", {
      requires: "clipboard,tabletools", onLoad: function () {
        ...
        CKEDITOR.plugins.tableselection.isSupportedEnvironment && (a.addContentsCss && a.addContentsCss(this.path + "/styles/tableselection.css"), a.on("contentDom", function () {
          ...
          x(a, c.selectedCells)
        }), F(a, ["cellMerge", "cellMergeRight", "cellMergeDown"],
          function (a, c) {
  ...
  (function () {
    ...
    function L(a) {
      ...
      b.on("drop", function (d) {
        var c = d.data.dataTransfer, f = c.getData("cke/widget-id"), h = c.getTransferType(b), c = b.createRange();
    ...
    function X(a) {
      if (a.draggable) {
        var b = a.editor,
          c = a.wrapper.getLast(g.isDomDragHandlerContainer), d;
    ...
    function Y(a) {
      ...
      var c = this.repository.finder, d = this.repository.locator, e = this.repository.liner, f = this.editor, h = f.editable(), g = [], k = [], m, n;
    ...
    var U = /^(?:<(?:div|span)(?: data-cke-temp="1")?(?: id="cke_copybin")?(?: data-cke-temp="1")?>)?(?:<(?:div|span)(?: style="[^"]+")?>)?<span [^>]*data-cke-copybin-start="1"[^>]*>.?<\/span>([\s\S]+)<span [^>]*data-cke-copybin-end="1"[^>]*>.?<\/span>(?:<\/(?:div|span)>)?(?:<\/(?:div|span)>)?$/i, da = {
      37: 1,
      38: 1,
      39: 1,
      40: 1,
  ...
  (function () {
    ...
    CKEDITOR.plugins.add("filetools", {
      beforeInit: function (a) {
        ...
        a.on("fileUploadRequest", function (a) {
          var b = a.data.fileLoader, c = new FormData;
        ...
        a.on("fileUploadResponse", function (a) {
          var b = a.data.fileLoader, c = b.xhr, f = a.data;
          try {
            var e = JSON.parse(c.responseText);
            e.error && e.error.message && (f.message = e.error.message);
            if (e.uploaded)for (var g in e)f[g] =
              e[g]; else a.cancel()
          } catch (h) {
            f.message = b.lang.filetools.responseError, CKEDITOR.warn("filetools-response-error", {responseText: c.responseText}), a.cancel()
          }
        }, null, null, 999)
      }
    });
    h.prototype = {
      create: function (a, d) {
        var b = this.loaders.length, c = new k(this.editor, a, d);
        c.id = b;
        this.loaders[b] = c;
    ...
    k.prototype = {
      loadAndUpload: function (a, d) {
        ...
        c.onload = function () {
          b.update();
          if ("abort" != b.status)if (b.uploaded = b.uploadTotal, 200 > c.status || 299 < c.status) b.message = b.lang.filetools["httpError" + c.status], b.message || (b.message = b.lang.filetools.httpError.replace("%1",
            c.status)), b.changeStatus("error"); else {
            for (var a = {fileLoader: b}, d = ["message", "fileName", "url"], g = b.editor.fire("fileUploadResponse", a), h = 0; h < d.length; h++) {
              var k = d[h];
    ...
    CKEDITOR.tools.extend(CKEDITOR.fileTools, {
      addUploadWidget: function (a, e, c) {
        ...
        if (c.fileToElement) a.on("paste", function (f) {
          f = f.data;
          var n = f.dataTransfer, k = n.getFilesCount(), m = c.loadMethod || "loadAndUpload", d,
            h;
        ...
        CKEDITOR.tools.extend(c, {
          downcast: function () {
            ...
            var f = this, e = this.wrapper.findOne("[data-cke-upload-id]").data("cke-upload-id"),
              k = b.loaders[e], c = CKEDITOR.tools.capitalize, d, h;
            ...
            if ("" === b.trim()) a.widgets.del(this); else {
              var c = this == a.widgets.focused, g = a.editable(), d = a.createRange(), h, l;
      ...
      bindNotifications: function (a, e) {
        ...
        e.on("update",
          function () {
            !b && e.uploadTotal && (c(), b = g.createTask({weight: e.uploadTotal}));
      ...
      requires: "uploadwidget", onLoad: function () {
        ...
        if (CKEDITOR.plugins.clipboard.isFileApiSupported) {
          ...
          h ? (f.addUploadWidget(d, "uploadimage", {
              supportedTypes: /image\/(jpeg|png|gif|bmp)/, uploadUrl: h, fileToElement: function () {
              ...
              if (a.data.dataValue.match(/<img[\s\S]+data:/i)) {
                a = a.data;
                var b = document.implementation.createHTMLDocument(""), b = new CKEDITOR.dom.element(b.body), l, c, g;
                b.data("cke-editable", 1);
                b.appendHtml(a.dataValue);
                l = b.find("img");
                for (g = 0; g < l.count(); g++) {
                  c = l.getItem(g);
                  var e = c.getAttribute("src") && "data:" == c.getAttribute("src").substring(0, 5), k = null === c.data("cke-realelement");
  ...
  (function () {
    function D(a) {
      ...
      function c() {
        ...
        (this.widget.focus(), delete this.focused), delete this.deflated; else {
          var b = this.widget, d = g, e = b.wrapper, c = b.data.align, b = b.data.hasCaption;
          if (d) {
      ...
      return {
        ...
        init: function () {
          var d = CKEDITOR.plugins.image2, b = this.parts.image, c = {
        ...
        getClasses: function () {
          ...
          return function () {
            var b = this.repository.parseElementClasses(m(this).getAttribute("class")), c;
    ...
    function H(a) {
      var b = n(a), c = a.config.image2_captionedClass;
      return function (a, f) {
    ...
    function I(a) {
      ...
      return function (a) {
        ...
        d && "none" != d && (e = CKEDITOR.tools.parseCssText(f.style || ""), "center" == d && "figure" == a.name ? a = a.wrapWith(new CKEDITOR.htmlParser.element("div", b ? {"class": b[1]} : {style: "text-align:center"})) : d in {
            left: 1,
            right: 1
    ...
    function G(a) {
      var b =
        a.editor, c = b.editable(), g = b.document, f = a.resizer = g.createElement("span");
      ...
      if (a.inline) a.wrapper.append(f); else {
        var d = a.parts.link || a.parts.image, e = d.getParent(), h = g.createElement("span");
      ...
      f.on("mousedown", function (d) {
        ...
        var h = a.parts.image, A = "right" == a.data.align ? -1 : 1, k = d.data.$.screenX, K = d.data.$.screenY, m = h.$.clientWidth, q = h.$.clientHeight, v = m / q, n = [], r = "cke_image_s" + (~A ? "e" : "w"), B, t, u, z, x, p, y;
        b.fire("saveSnapshot");
    ...
    function L(a) {
      ...
      return function (g) {
        ...
        if (f) {
          ...
          if (g in {right: 1, left: 1, center: 1}) f.on("exec", function (d) {
            var c = k(a);
            if (c) {
              c.setData("align", g);
          ...
          f.on("refresh", function (b) {
            var f = k(a), h = {right: 1, left: 1, center: 1};
    ...
    function M(a) {
      a.plugins.link && (CKEDITOR.on("dialogDefinition", function (b) {
        ...
        if ("link" == b.name) {
          b = b.definition;
          var c = b.onShow, g = b.onOk;
          b.onShow = function () {
            var b = k(a), d = this.getContentElement("info", "linkDisplayText").getElement().getParent().getParent();
    ...
    var N = new CKEDITOR.template('\x3cfigure class\x3d"{captionedClass}"\x3e\x3cimg alt\x3d"" src\x3d"" /\x3e\x3cfigcaption\x3e{captionPlaceholder}\x3c/figcaption\x3e\x3c/figure\x3e'), q = {
      left: 0,
      center: 1,
      right: 2
    }, J = /^\s*(\d+\%)\s*$/i;
    CKEDITOR.plugins.add("image2", {
      ...
      init: function (a) {
        var b = a.config, c = a.lang.image2, g = D(a);
        ...
        var b = {left: 1, right: 1, center: 1, block: 1}, c = L(a), g;
        for (g in b)c(g);
        M(a)
      }
    });
          ...
          align: function (d, c, g) {
            ...
            if (b.changed.link) {
              var e = b.element.is("img") ? b.element : b.element.findOne("img"),
                f = b.element.is("a") ? b.element : b.element.findOne("a"), h = b.element.is("a") && !c || b.element.is("img") && c, k;
              h && b.deflate();
              c ? (d || (k = g.createElement("a", {attributes: {href: b.newData.link.url}}), k.replace(e), e.move(k)), c = CKEDITOR.plugins.image2.getLinkAttributesGetter()(a, c), CKEDITOR.tools.isEmpty(c.set) || (k || f).setAttributes(c.set), c.removed.length && (k || f).removeAttributes(c.removed)) : (c = f.findOne("img"), c.replace(f), k = c);
              h && (b.element = k)
            }
          }
        };
  ...
  (function () {
    CKEDITOR.plugins.add("youtube", {
      lang: "en pt pt-br ja hu it fr tr ru de ar nl pl vi zh el he es nb nn fi et sk cs ko".split(" "),
      init: function (a) {
        a.addCommand("youtube", new CKEDITOR.dialogCommand("youtube", {allowedContent: "div{*}(*); iframe{*}[!width,!height,!src,!frameborder,!allowfullscreen]; object param[*]; a[*]; img[*]"}));
        ...
        CKEDITOR.dialog.add("youtube", function (b) {
          var e,
            c = a.config.youtube_disabled_fields || [];
          return {
            title: a.lang.youtube.title, minWidth: 510, minHeight: 200, onShow: function () {
              for (var a = 0; a < c.length; a++)this.getContentElement("youtubePlugin", c[a]).disable()
            }, contents: [{
              id: "youtubePlugin", expand: !0, elements: [{
                id: "txtEmbed", type: "textarea", label: a.lang.youtube.txtEmbed, onChange: function (a) {
                  handleEmbedChange(this, a)
                }, onKeyUp: function (a) {
                  handleEmbedChange(this, a)
                }, validate: function () {
                  if (this.isEnabled()) {
                    if (!this.getValue())return alert(a.lang.youtube.noCode),
                      !1;
                    if (0 === this.getValue().length || -1 === this.getValue().indexOf("//"))return alert(a.lang.youtube.invalidEmbed), !1
                  }
                }
              }, {type: "html", html: a.lang.youtube.or + "\x3chr\x3e"}, {
                type: "hbox", widths: ["70%", "15%", "15%"], children: [{
                  id: "txtUrl", type: "text", label: a.lang.youtube.txtUrl, onChange: function (a) {
                    handleLinkChange(this, a)
                  }, onKeyUp: function (a) {
                    handleLinkChange(this, a)
                  }, validate: function () {
                    if (this.isEnabled())if (this.getValue()) {
                      if (e = ytVidId(this.getValue()), 0 === this.getValue().length || !1 === e)return alert(a.lang.youtube.invalidUrl),
                        !1
                ...
                children: [{
                  ...
                  id: "chkNoEmbed",
                  type: "checkbox",
                  label: a.lang.youtube.txtNoEmbed,
                  "default": null != a.config.youtube_noembed ? a.config.youtube_noembed : !1
                }]
              }, {
                ...
                children: [{
                  ...
                  id: "chkAutoplay", type: "checkbox", "default": null != a.config.youtube_autoplay ?
                    a.config.youtube_autoplay : !1, label: a.lang.youtube.chkAutoplay
                }]
              }, {
                type: "hbox",
                widths: ["55%", "45%"],
                children: [{
                  id: "txtStartAt", type: "text", label: a.lang.youtube.txtStartAt, validate: function () {
                    if (this.getValue()) {
                      var k = this.getValue();
                      if (!/^(?:(?:([01]?\d|2[0-3]):)?([0-5]?\d):)?([0-5]?\d)$/i.test(k))return alert(a.lang.youtube.invalidTime), !1
                    }
                  }
                }, {
                  id: "chkControls",
                  type: "checkbox",
                  "default": null != a.config.youtube_controls ? a.config.youtube_controls : !0,
                  label: a.lang.youtube.chkControls
                }]
              }]
            }], onOk: function () {
              var a =
              ...
              if (this.getContentElement("youtubePlugin", "txtEmbed").isEnabled()) a = this.getValueOf("youtubePlugin", "txtEmbed"); else {
                var d = "https://", b = [], f, g = this.getValueOf("youtubePlugin", "txtWidth"), h = this.getValueOf("youtubePlugin", "txtHeight"), d = !0 === this.getContentElement("youtubePlugin", "chkPrivacy").getValue() ? d + "www.youtube-nocookie.com/" : d + "www.youtube.com/", d = d + ("embed/" + e);
                !1 === this.getContentElement("youtubePlugin", "chkRelated").getValue() && b.push("rel\x3d0");
                !0 === this.getContentElement("youtubePlugin",
                  "chkAutoplay").getValue() && b.push("autoplay\x3d1");
                !1 === this.getContentElement("youtubePlugin", "chkControls").getValue() && b.push("controls\x3d0");
                if (f = this.getValueOf("youtubePlugin", "txtStartAt")) f = hmsToSeconds(f), b.push("start\x3d" + f);
                0 < b.length && (d = d + "?" + b.join("\x26"));
                !0 === this.getContentElement("youtubePlugin", "chkResponsive").getValue() && (a += '\x3cdiv class\x3d"youtube-embed-wrapper" style\x3d"position:relative;padding-bottom:56.25%;padding-top:30px;height:0;overflow:hidden"\x3e', c = 'style\x3d"position:absolute;top:0;left:0;width:100%;height:100%"');
                !0 === this.getContentElement("youtubePlugin", "chkOlderCode").getValue() ? (d = d.replace("embed/", "v/"), d = d.replace(/&/g, "\x26amp;"), d = -1 === d.indexOf("?") ? d + "?" : d + "\x26amp;", d += "hl\x3d" + (this.getParentEditor().config.language ? this.getParentEditor().config.language : "en") + "\x26amp;version\x3d3", a = a + ('\x3cobject width\x3d"' + g + '" height\x3d"' + h + '" ' + c + "\x3e") + ('\x3cparam name\x3d"movie" value\x3d"' + d + '"\x3e\x3c/param\x3e'), a += '\x3cparam name\x3d"allowFullScreen" value\x3d"true"\x3e\x3c/param\x3e', a += '\x3cparam name\x3d"allowscriptaccess" value\x3d"always"\x3e\x3c/param\x3e',
                    a += '\x3cembed src\x3d"' + d + '" type\x3d"application/x-shockwave-flash" ', a += 'width\x3d"' + g + '" height\x3d"' + h + '" ' + c + ' allowscriptaccess\x3d"always" ', a += 'allowfullscreen\x3d"true"\x3e\x3c/embed\x3e', a += "\x3c/object\x3e") : !0 === this.getContentElement("youtubePlugin", "chkNoEmbed").getValue() ? a += '\x3ca href\x3d"' + d + '" \x3e\x3cimg width\x3d"' + g + '" height\x3d"' + h + '" src\x3d"' + ("//img.youtube.com/vi/" + e + "/sddefault.jpg") + '" ' + c + "/\x3e\x3c/a\x3e" : (a += '\x3ciframe width\x3d"' + g + '" height\x3d"' + h + '" src\x3d"' +
                      d + '" ' + c, a += 'frameborder\x3d"0" allowfullscreen\x3e\x3c/iframe\x3e');
                !0 === this.getContentElement("youtubePlugin", "chkResponsive").getValue() && (a += "\x3c/div\x3e")
              }
  ...
  function handleLinkChange(a, b) {
    var e = ytVidId(a.getValue()), c = ytVidTime(a.getValue());
    ...
    e && c && (e = timeParamToSeconds(c), e = secondsToHms(e), a.getDialog().getContentElement("youtubePlugin", "txtStartAt").setValue(e))
  }

  function handleEmbedChange(a, b) {
  ...
  function ytVidTime(a) {
    return a.match(/t=([0-9hms]+)/) ? RegExp.$1 : !1
  }

  function hmsToSeconds(a) {
    a = a.split(":");
    for (var b = 0, e = 1; 0 < a.length;)b += e * parseInt(a.pop(), 10), e *= 60;
    return b
  }

  function secondsToHms(a) {
    var b = Math.floor(a / 3600), e = Math.floor(a / 60 % 60);
    a %= 60;
    var c = function (a) {
      a = String(a);
      return 2 <= a.length ? a : "0" + a
    };
    return 0 < b ? c(b) + ":" + c(e) + ":" + c(a) : c(e) + ":" + c(a)
  }

  function timeParamToSeconds(a) {
    var b = function (b) {
      return a.match(new RegExp("(\\d+)" + b)) ? parseInt(RegExp.$1, 10) : 0
    };
    return 3600 * b("h") + 60 * b("m") + b("s")
  }

  function secondsToTimeParam(a) {
    var b = Math.floor(a / 3600), e = Math.floor(a / 60 % 60);
    a %= 60;
    var c = "";
    0 < b && (c += b + "h");
  ...
  (function () {
    ...
    if (CKEDITOR.env.hidpi) setIcons('about,0,,bold,24,,italic,48,,strike,72,,subscript,96,,superscript,120,,underline,144,,blockquote,168,,copy-rtl,192,,copy,216,,cut-rtl,240,,cut,264,,paste-rtl,288,,paste,312,,horizontalrule,336,,image,360,,indent-rtl,384,,indent,408,,outdent-rtl,432,,outdent,456,,anchor-rtl,480,,anchor,504,,link,528,,unlink,552,,bulletedlist-rtl,576,,bulletedlist,600,,numberedlist-rtl,624,,numberedlist,648,,maximize,672,,pastetext-rtl,696,,pastetext,720,,pastefromword-rtl,744,,pastefromword,768,,removeformat,792,,source-rtl,816,,source,840,,specialchar,864,,scayt,888,,table,912,,redo-rtl,936,,redo,960,,undo-rtl,984,,undo,1008,,spellchecker,1032,,justifyblock,1056,,justifycenter,1080,,justifyleft,1104,,justifyright,1128,', 'icons_hidpi.png'); else setIcons('about,0,auto,bold,24,auto,italic,48,auto,strike,72,auto,subscript,96,auto,superscript,120,auto,underline,144,auto,blockquote,168,auto,copy-rtl,192,auto,copy,216,auto,cut-rtl,240,auto,cut,264,auto,paste-rtl,288,auto,paste,312,auto,horizontalrule,336,auto,image,360,auto,indent-rtl,384,auto,indent,408,auto,outdent-rtl,432,auto,outdent,456,auto,anchor-rtl,480,auto,anchor,504,auto,link,528,auto,unlink,552,auto,bulletedlist-rtl,576,auto,bulletedlist,600,auto,numberedlist-rtl,624,auto,numberedlist,648,auto,maximize,672,auto,pastetext-rtl,696,auto,pastetext,720,auto,pastefromword-rtl,744,auto,pastefromword,768,auto,removeformat,792,auto,source-rtl,816,auto,source,840,auto,specialchar,864,auto,scayt,888,auto,table,912,auto,redo-rtl,936,auto,redo,960,auto,undo-rtl,984,auto,undo,1008,auto,spellchecker,1032,auto,justifyblock,1056,auto,justifycenter,1080,auto,justifyleft,1104,auto,justifyright,1128,auto', 'icons.png');
  })();
